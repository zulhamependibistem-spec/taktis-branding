...
export const SPG_NAV: NavItem[] = [
  ...
  { key: "sales", label: "Reporting", icon: "assignment", href: "/spg/sales" },
...
export const TL_NAV: NavItem[] = [
  ...
  { key: "performa", label: "Performa", icon: "analytics", href: "/tl/performa" },
  { key: "harga", label: "Harga", icon: "edit", href: "/tl/harga" },
  { key: "profil", label: "Profil", icon: "person", href: "/tl/profil" },
];